...
Below is an example of the input mask pattern and the output image intensity (EM). Graph-R is used to plot the image intensity but you can use any plotting software.
